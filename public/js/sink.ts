var chart;
var enviados: any = [0, 0, 0, 0]; //Paquetes enviados por robot.
var tipo1Recibidos: any = [0, 0, 0, 0]; //Recibidos por robot.
var tipo2Recibidos: any = [0, 0, 0, 0]; //Recibidos por robot.
var tipo1PorRobot: any = [0, 0, 0, 0];
var tipo2PorRobot: any = [0, 0, 0, 0];
var recargar: boolean = false;
var idSimulacion: number;   //Usada para parar la simulación
var totalPaquetes: number = 0;
var totalRecibidos: number = 0;
var totalTipo1: number = 0;
var totalTipo2: number = 0;
...
var ProcessPacket = function(paquete:IPacket) {
